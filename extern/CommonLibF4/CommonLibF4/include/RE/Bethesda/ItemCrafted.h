...
namespace RE
{
	...
	namespace ItemCrafted
	{
		...
		inline void NotifyOfItemCrafted(const TESFurniture* a_workbench, const BGSConstructibleObject* a_recipe)
		{
			...
			static REL::Relocation<func_t> func{ REL::RelocationID(788895, 2232809) };
		...
		inline void RegisterSink(BSTEventSink<Event>* a_sink)
		{
			...
			static REL::Relocation<func_t> func{ REL::RelocationID(1320496, 2232807) };
			return func(a_sink);
		}
		...
		inline void UnregisterSink(BSTEventSink<Event>* a_sink)
		{
			...
			static REL::Relocation<func_t> func{ REL::RelocationID(1054567, 2232808) };
			return func(a_sink);
		}
	}
}
