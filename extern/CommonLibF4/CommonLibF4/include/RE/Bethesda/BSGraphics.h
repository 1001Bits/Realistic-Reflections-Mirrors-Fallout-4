...
namespace RE
{
	...
	namespace BSGraphics
	{
		...
		// FO4 PORT: ShadowStateData overlay for Community Shaders compat
		// TODO: offsets need verification via Ghidra RE (0x910 total)
		struct ShadowStateData;  // defined in FO4Compat.h
		...
		public:
			...
			// FO4 PORT: These return a reinterpret_cast overlay. Offsets unverified.
			ShadowStateData& GetRuntimeData();
			const ShadowStateData& GetRuntimeData() const;
			ShadowStateData& GetVRRuntimeData();
			const ShadowStateData& GetVRRuntimeData() const;
		};
