...
namespace RE
{
	...
	public:
		...
		static inline REL::Relocation<bool*>& bDisable() {
			static REL::Relocation<bool*> value{ REL::RelocationID(372489, 2713225) };
			return value;
		}
	...
	public:
		...
		static inline REL::Relocation<bool*>& bDisable() {
			static REL::Relocation<bool*> value{ REL::RelocationID(1523708, 2713237) };
			return value;
		}
	...
	public:
		...
		static inline REL::Relocation<bool*>& bPowerArmorPipboy() {
			static REL::Relocation<bool*> value{ REL::ID(1065542) };
			return value;
		}
	...
	public:
		...
		static inline REL::Relocation<bool*>& bDisable() {
			static REL::Relocation<bool*> value{ REL::RelocationID(1500590, 2713225) };
			return value;
		}
	};
	...
	public:
		...
		static inline REL::Relocation<std::uint32_t*>& MaskS() {
			static REL::Relocation<std::uint32_t*> value{ REL::ID(775377) };
			return value;
		}
