...
namespace RE
{
	...
	namespace Workshop
	{
		...
		inline REL::Relocation<PlacementItemData*>& CurrentPlacementItemData() {
			static REL::Relocation<PlacementItemData*> value{ REL::ID(1279207) };
			return value;
		}
		inline REL::Relocation<std::uint16_t*>& CurrentRow() {
			static REL::Relocation<std::uint16_t*> value{ REL::ID(833923) };
			return value;
		}
		inline REL::Relocation<ObjectRefHandle*>& PlacementItem() {
			static REL::Relocation<ObjectRefHandle*> value{ REL::ID(526727) };
			return value;
		}
	}
}
